...
//  leanring-buddy
//
//  The four-bar voice waveform from the Auren fork. The CAShapeLayer NSView is
//  ported as-is; only the SwiftUI wrapper changed: instead of reading
...
// MARK: - NSView (ported verbatim from Auren)
